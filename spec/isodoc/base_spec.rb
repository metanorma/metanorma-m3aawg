...
RSpec.describe IsoDoc::M3AAWG do
  ...
  it "processes pre" do
    ...
    OUTPUT
    expect(xmlpp(IsoDoc::M3AAWG::HtmlConvert.new({})
  ...
  it "processes section names" do
    ...
    output = <<~OUTPUT
      ...
      <foreword obligation="informative" displayorder="1">
       ...
       <clause id="H" obligation="normative" displayorder="4"><title depth="1">2.<tab/>Terms, definitions, symbols and abbreviated terms</title><terms id="I" obligation="normative">
